...
import { resetPasswordBuyer } from '../../helper/helperBuyer';

export default function Resetbuyer() {
    ...
    const formik = useFormik({
        ...
        onSubmit : async values => {
            ...
            const resetPromise = resetPasswordBuyer({ username, password : values.password });
    ...
    if (status && status === 440) {
        toast.error("Send OTP to Reset Password");
