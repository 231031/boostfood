...
export default function Addfood() {
    ...
    const formik = useFormik({
        ...
        onSubmit : async values => {
            ...
            addFood({username : apiData.username, foodDetail: values})
            .then((res) => {
                toast.success(res);
            })
            .catch((error) => {
            ...
            <div className='bg-lime-500 p-7 rounded-xl drop-shadow-2xl w-4/5'>
                ...
                <form className='py-2' onSubmit={formik.handleSubmit} >
                    ...
                    <div className='textbox flex flex-col justify-center items-center'>
                        <input {...formik.getFieldProps('foodname')} type='text' placeholder='Food Name' className='shadow-md rounded-md w-5/6 text-lg'></input><br/>
